...
func (v1 *V1) ValidateKeyAccessData(
	ctx context.Context,
...
func (v1 *V1) TransformCryptoAccessData(
	ctx context.Context,
...
func (v1 *V1) ExtractKeyRegion(ctx context.Context,
