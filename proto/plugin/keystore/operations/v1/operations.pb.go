...
func (x *GetKeyVersionsRequest) GetParameters() *RequestParameters {
	if x != nil {
		return x.Parameters
	}
	return nil
...
type GetKeyVersionsResponse struct {
	state         protoimpl.MessageState               `protogen:"open.v1"`
	Versions      []*GetKeyVersionsResponse_KeyVersion `protobuf:"bytes,1,rep,name=versions,proto3" json:"versions,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetKeyVersionsResponse) GetVersions() []*GetKeyVersionsResponse_KeyVersion {
	if x != nil {
		return x.Versions
	}
	return nil
...
func (x *ExtractKeyRegionRequest) Reset() {
	*x = ExtractKeyRegionRequest{}
	mi := &file_plugin_keystore_operations_v1_operations_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExtractKeyRegionRequest) Descriptor() ([]byte, []int) {
	return file_plugin_keystore_operations_v1_operations_proto_rawDescGZIP(), []int{23}
}
...
func (x *ExtractKeyRegionResponse) Reset() {
	*x = ExtractKeyRegionResponse{}
	mi := &file_plugin_keystore_operations_v1_operations_proto_msgTypes[24]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ExtractKeyRegionResponse) Descriptor() ([]byte, []int) {
	return file_plugin_keystore_operations_v1_operations_proto_rawDescGZIP(), []int{24}
}
...
type GetKeyVersionsResponse_KeyVersion struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetKeyVersionsResponse_KeyVersion) Reset() {
	*x = GetKeyVersionsResponse_KeyVersion{}
	mi := &file_plugin_keystore_operations_v1_operations_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetKeyVersionsResponse_KeyVersion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetKeyVersionsResponse_KeyVersion) ProtoMessage() {}

func (x *GetKeyVersionsResponse_KeyVersion) ProtoReflect() protoreflect.Message {
	mi := &file_plugin_keystore_operations_v1_operations_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetKeyVersionsResponse_KeyVersion.ProtoReflect.Descriptor instead.
func (*GetKeyVersionsResponse_KeyVersion) Descriptor() ([]byte, []int) {
	return file_plugin_keystore_operations_v1_operations_proto_rawDescGZIP(), []int{4, 0}
}

func (x *GetKeyVersionsResponse_KeyVersion) GetVersionId() string {
	if x != nil {
		return x.VersionId
	}
	return ""
...
func (x *GetKeyVersionsResponse_KeyVersion) GetCreationTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *GetKeyVersionsResponse_KeyVersion) GetStatus() string {
...
const file_plugin_keystore_operations_v1_operations_proto_rawDesc = "" +
	"\n" +
	".plugin/keystore/operations/v1/operations.proto\x12\x1dplugin.keystore.operations.v1\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a&plugin/keystore/common/v1/common.proto\"u\n" +
	...
	"\x10ExtractKeyRegion\x126.plugin.keystore.operations.v1.ExtractKeyRegionRequest\x1a7.plugin.keystore.operations.v1.ExtractKeyRegionResponseBPZNgithub.com/openkcm/plugin-sdk/proto/plugin/keystore/operations/v1;operationsv1b\x06proto3"
...
var file_plugin_keystore_operations_v1_operations_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_plugin_keystore_operations_v1_operations_proto_goTypes = []any{
	...
	(*GetKeyVersionsRequest)(nil),             // 5: plugin.keystore.operations.v1.GetKeyVersionsRequest
	(*GetKeyVersionsResponse)(nil),            // 6: plugin.keystore.operations.v1.GetKeyVersionsResponse
	(*CreateKeyRequest)(nil),                  // 7: plugin.keystore.operations.v1.CreateKeyRequest
	(*CreateKeyResponse)(nil),                 // 8: plugin.keystore.operations.v1.CreateKeyResponse
	(*DeleteKeyRequest)(nil),                  // 9: plugin.keystore.operations.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),                 // 10: plugin.keystore.operations.v1.DeleteKeyResponse
	(*EnableKeyRequest)(nil),                  // 11: plugin.keystore.operations.v1.EnableKeyRequest
	(*EnableKeyResponse)(nil),                 // 12: plugin.keystore.operations.v1.EnableKeyResponse
	(*DisableKeyRequest)(nil),                 // 13: plugin.keystore.operations.v1.DisableKeyRequest
	(*DisableKeyResponse)(nil),                // 14: plugin.keystore.operations.v1.DisableKeyResponse
	(*GetImportParametersRequest)(nil),        // 15: plugin.keystore.operations.v1.GetImportParametersRequest
	(*GetImportParametersResponse)(nil),       // 16: plugin.keystore.operations.v1.GetImportParametersResponse
	(*ImportKeyMaterialRequest)(nil),          // 17: plugin.keystore.operations.v1.ImportKeyMaterialRequest
	(*ImportKeyMaterialResponse)(nil),         // 18: plugin.keystore.operations.v1.ImportKeyMaterialResponse
	(*ValidateKeyRequest)(nil),                // 19: plugin.keystore.operations.v1.ValidateKeyRequest
	(*ValidateKeyResponse)(nil),               // 20: plugin.keystore.operations.v1.ValidateKeyResponse
	(*ValidateKeyAccessDataRequest)(nil),      // 21: plugin.keystore.operations.v1.ValidateKeyAccessDataRequest
	(*ValidateKeyAccessDataResponse)(nil),     // 22: plugin.keystore.operations.v1.ValidateKeyAccessDataResponse
	(*TransformCryptoAccessDataRequest)(nil),  // 23: plugin.keystore.operations.v1.TransformCryptoAccessDataRequest
	(*TransformCryptoAccessDataResponse)(nil), // 24: plugin.keystore.operations.v1.TransformCryptoAccessDataResponse
	(*ExtractKeyRegionRequest)(nil),           // 25: plugin.keystore.operations.v1.ExtractKeyRegionRequest
	(*ExtractKeyRegionResponse)(nil),          // 26: plugin.keystore.operations.v1.ExtractKeyRegionResponse
	(*GetKeyVersionsResponse_KeyVersion)(nil), // 27: plugin.keystore.operations.v1.GetKeyVersionsResponse.KeyVersion
	nil,                               // 28: plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.TransformedAccessDataEntry
	(*v1.KeystoreInstanceConfig)(nil), // 29: plugin.keystore.common.v1.KeystoreInstanceConfig
	(*timestamppb.Timestamp)(nil),     // 30: google.protobuf.Timestamp
	(*structpb.Struct)(nil),           // 31: google.protobuf.Struct
}
var file_plugin_keystore_operations_v1_operations_proto_depIdxs = []int32{
	29, // 0: plugin.keystore.operations.v1.RequestParameters.config:type_name -> plugin.keystore.common.v1.KeystoreInstanceConfig
	...
	30, // 3: plugin.keystore.operations.v1.GetKeyResponse.latest_rotation_time:type_name -> google.protobuf.Timestamp
	2,  // 4: plugin.keystore.operations.v1.GetKeyVersionsRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	27, // 5: plugin.keystore.operations.v1.GetKeyVersionsResponse.versions:type_name -> plugin.keystore.operations.v1.GetKeyVersionsResponse.KeyVersion
	29, // 6: plugin.keystore.operations.v1.CreateKeyRequest.config:type_name -> plugin.keystore.common.v1.KeystoreInstanceConfig
	0,  // 7: plugin.keystore.operations.v1.CreateKeyRequest.algorithm:type_name -> plugin.keystore.operations.v1.KeyAlgorithm
	1,  // 8: plugin.keystore.operations.v1.CreateKeyRequest.key_type:type_name -> plugin.keystore.operations.v1.KeyType
	2,  // 9: plugin.keystore.operations.v1.DeleteKeyRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	2,  // 10: plugin.keystore.operations.v1.EnableKeyRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	2,  // 11: plugin.keystore.operations.v1.DisableKeyRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	2,  // 12: plugin.keystore.operations.v1.GetImportParametersRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	0,  // 13: plugin.keystore.operations.v1.GetImportParametersRequest.algorithm:type_name -> plugin.keystore.operations.v1.KeyAlgorithm
	31, // 14: plugin.keystore.operations.v1.GetImportParametersResponse.import_parameters:type_name -> google.protobuf.Struct
	2,  // 15: plugin.keystore.operations.v1.ImportKeyMaterialRequest.parameters:type_name -> plugin.keystore.operations.v1.RequestParameters
	31, // 16: plugin.keystore.operations.v1.ImportKeyMaterialRequest.import_parameters:type_name -> google.protobuf.Struct
	1,  // 17: plugin.keystore.operations.v1.ValidateKeyRequest.key_type:type_name -> plugin.keystore.operations.v1.KeyType
	0,  // 18: plugin.keystore.operations.v1.ValidateKeyRequest.algorithm:type_name -> plugin.keystore.operations.v1.KeyAlgorithm
	31, // 19: plugin.keystore.operations.v1.ValidateKeyAccessDataRequest.management:type_name -> google.protobuf.Struct
	31, // 20: plugin.keystore.operations.v1.ValidateKeyAccessDataRequest.crypto:type_name -> google.protobuf.Struct
	28, // 21: plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.transformed_access_data:type_name -> plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.TransformedAccessDataEntry
	31, // 22: plugin.keystore.operations.v1.ExtractKeyRegionRequest.management_access_data:type_name -> google.protobuf.Struct
	30, // 23: plugin.keystore.operations.v1.GetKeyVersionsResponse.KeyVersion.creation_time:type_name -> google.protobuf.Timestamp
	3,  // 24: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKey:input_type -> plugin.keystore.operations.v1.GetKeyRequest
	5,  // 25: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKeyVersions:input_type -> plugin.keystore.operations.v1.GetKeyVersionsRequest
	7,  // 26: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKey:input_type -> plugin.keystore.operations.v1.CreateKeyRequest
	9,  // 27: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DeleteKey:input_type -> plugin.keystore.operations.v1.DeleteKeyRequest
	11, // 28: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.EnableKey:input_type -> plugin.keystore.operations.v1.EnableKeyRequest
	13, // 29: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DisableKey:input_type -> plugin.keystore.operations.v1.DisableKeyRequest
	15, // 30: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetImportParameters:input_type -> plugin.keystore.operations.v1.GetImportParametersRequest
	17, // 31: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ImportKeyMaterial:input_type -> plugin.keystore.operations.v1.ImportKeyMaterialRequest
	19, // 32: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKey:input_type -> plugin.keystore.operations.v1.ValidateKeyRequest
	21, // 33: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKeyAccessData:input_type -> plugin.keystore.operations.v1.ValidateKeyAccessDataRequest
	23, // 34: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.TransformCryptoAccessData:input_type -> plugin.keystore.operations.v1.TransformCryptoAccessDataRequest
	25, // 35: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ExtractKeyRegion:input_type -> plugin.keystore.operations.v1.ExtractKeyRegionRequest
	4,  // 36: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKey:output_type -> plugin.keystore.operations.v1.GetKeyResponse
	6,  // 37: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKeyVersions:output_type -> plugin.keystore.operations.v1.GetKeyVersionsResponse
	8,  // 38: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKey:output_type -> plugin.keystore.operations.v1.CreateKeyResponse
	10, // 39: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DeleteKey:output_type -> plugin.keystore.operations.v1.DeleteKeyResponse
	12, // 40: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.EnableKey:output_type -> plugin.keystore.operations.v1.EnableKeyResponse
	14, // 41: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DisableKey:output_type -> plugin.keystore.operations.v1.DisableKeyResponse
	16, // 42: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetImportParameters:output_type -> plugin.keystore.operations.v1.GetImportParametersResponse
	18, // 43: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ImportKeyMaterial:output_type -> plugin.keystore.operations.v1.ImportKeyMaterialResponse
	20, // 44: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKey:output_type -> plugin.keystore.operations.v1.ValidateKeyResponse
	22, // 45: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKeyAccessData:output_type -> plugin.keystore.operations.v1.ValidateKeyAccessDataResponse
	24, // 46: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.TransformCryptoAccessData:output_type -> plugin.keystore.operations.v1.TransformCryptoAccessDataResponse
	26, // 47: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ExtractKeyRegion:output_type -> plugin.keystore.operations.v1.ExtractKeyRegionResponse
...
func file_plugin_keystore_operations_v1_operations_proto_init() {
	...
	file_plugin_keystore_operations_v1_operations_proto_msgTypes[2].OneofWrappers = []any{}
	file_plugin_keystore_operations_v1_operations_proto_msgTypes[5].OneofWrappers = []any{}
	file_plugin_keystore_operations_v1_operations_proto_msgTypes[7].OneofWrappers = []any{}
	file_plugin_keystore_operations_v1_operations_proto_msgTypes[25].OneofWrappers = []any{}
	type x struct{}
