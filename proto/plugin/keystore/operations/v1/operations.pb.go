...
// Deprecated: Use CreateKeyForImportRequest instead
//
// Deprecated: Marked as deprecated in plugin/keystore/operations/v1/operations.proto.
type CreateKeyRequest struct {
	...
	KeyType       KeyType                    `protobuf:"varint,5,opt,name=key_type,json=keyType,proto3,enum=plugin.keystore.operations.v1.KeyType" json:"key_type,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// CreateKeyForImportRequest contains parameters for key creation
...
const file_plugin_keystore_operations_v1_operations_proto_rawDesc = "" +
	...
	"\x15_latest_rotation_time\"\xa3\x02\n" +
	...
	"\bkey_type\x18\x05 \x01(\x0e2&.plugin.keystore.operations.v1.KeyTypeR\akeyType:\x02\x18\x01B\x05\n" +
	"\x03_id\"F\n" +
	"\x11CreateKeyResponse\x12\x15\n" +
	"\x06key_id\x18\x01 \x01(\tR\x05keyId\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status:\x02\x18\x01\"\xe5\x01\n" +
	...
	"\rKEY_TYPE_HYOK\x10\x03\"\x04\b\x01\x10\x01*\x17KEY_TYPE_SYSTEM_MANAGED2\xa3\f\n" +
	"\x1cKeystoreInstanceKeyOperation\x12e\n" +
	"\x06GetKey\x12,.plugin.keystore.operations.v1.GetKeyRequest\x1a-.plugin.keystore.operations.v1.GetKeyResponse\x12s\n" +
	"\tCreateKey\x12/.plugin.keystore.operations.v1.CreateKeyRequest\x1a0.plugin.keystore.operations.v1.CreateKeyResponse\"\x03\x88\x02\x01\x12\x89\x01\n" +
...
var file_plugin_keystore_operations_v1_operations_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_plugin_keystore_operations_v1_operations_proto_goTypes = []any{
	...
	(*CreateKeyForImportRequest)(nil),         // 7: plugin.keystore.operations.v1.CreateKeyForImportRequest
	(*CreateKeyForImportResponse)(nil),        // 8: plugin.keystore.operations.v1.CreateKeyForImportResponse
	...
	nil,                                       // 27: plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.TransformedAccessDataEntry
	(*v1.KeystoreInstanceConfig)(nil),         // 28: plugin.keystore.common.v1.KeystoreInstanceConfig
	(*timestamppb.Timestamp)(nil),             // 29: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                   // 30: google.protobuf.Struct
}
var file_plugin_keystore_operations_v1_operations_proto_depIdxs = []int32{
	28, // 0: plugin.keystore.operations.v1.RequestParameters.config:type_name -> plugin.keystore.common.v1.KeystoreInstanceConfig
	...
	29, // 3: plugin.keystore.operations.v1.GetKeyResponse.latest_rotation_time:type_name -> google.protobuf.Timestamp
	28, // 4: plugin.keystore.operations.v1.CreateKeyRequest.config:type_name -> plugin.keystore.common.v1.KeystoreInstanceConfig
	...
	28, // 7: plugin.keystore.operations.v1.CreateKeyForImportRequest.config:type_name -> plugin.keystore.common.v1.KeystoreInstanceConfig
	0,  // 8: plugin.keystore.operations.v1.CreateKeyForImportRequest.algorithm:type_name -> plugin.keystore.operations.v1.KeyAlgorithm
	...
	30, // 14: plugin.keystore.operations.v1.GetImportParametersResponse.import_parameters:type_name -> google.protobuf.Struct
	...
	30, // 16: plugin.keystore.operations.v1.ImportKeyMaterialRequest.import_parameters:type_name -> google.protobuf.Struct
	...
	30, // 19: plugin.keystore.operations.v1.ValidateKeyAccessDataRequest.management:type_name -> google.protobuf.Struct
	30, // 20: plugin.keystore.operations.v1.ValidateKeyAccessDataRequest.crypto:type_name -> google.protobuf.Struct
	27, // 21: plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.transformed_access_data:type_name -> plugin.keystore.operations.v1.TransformCryptoAccessDataResponse.TransformedAccessDataEntry
	30, // 22: plugin.keystore.operations.v1.ExtractKeyRegionRequest.management_access_data:type_name -> google.protobuf.Struct
	3,  // 23: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKey:input_type -> plugin.keystore.operations.v1.GetKeyRequest
	5,  // 24: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKey:input_type -> plugin.keystore.operations.v1.CreateKeyRequest
	7,  // 25: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKeyForImport:input_type -> plugin.keystore.operations.v1.CreateKeyForImportRequest
	9,  // 26: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DeleteKey:input_type -> plugin.keystore.operations.v1.DeleteKeyRequest
	11, // 27: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.EnableKey:input_type -> plugin.keystore.operations.v1.EnableKeyRequest
	13, // 28: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DisableKey:input_type -> plugin.keystore.operations.v1.DisableKeyRequest
	15, // 29: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetImportParameters:input_type -> plugin.keystore.operations.v1.GetImportParametersRequest
	17, // 30: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ImportKeyMaterial:input_type -> plugin.keystore.operations.v1.ImportKeyMaterialRequest
	19, // 31: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKey:input_type -> plugin.keystore.operations.v1.ValidateKeyRequest
	21, // 32: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKeyAccessData:input_type -> plugin.keystore.operations.v1.ValidateKeyAccessDataRequest
	23, // 33: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.TransformCryptoAccessData:input_type -> plugin.keystore.operations.v1.TransformCryptoAccessDataRequest
	25, // 34: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ExtractKeyRegion:input_type -> plugin.keystore.operations.v1.ExtractKeyRegionRequest
	4,  // 35: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetKey:output_type -> plugin.keystore.operations.v1.GetKeyResponse
	6,  // 36: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKey:output_type -> plugin.keystore.operations.v1.CreateKeyResponse
	8,  // 37: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.CreateKeyForImport:output_type -> plugin.keystore.operations.v1.CreateKeyForImportResponse
	10, // 38: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DeleteKey:output_type -> plugin.keystore.operations.v1.DeleteKeyResponse
	12, // 39: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.EnableKey:output_type -> plugin.keystore.operations.v1.EnableKeyResponse
	14, // 40: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.DisableKey:output_type -> plugin.keystore.operations.v1.DisableKeyResponse
	16, // 41: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.GetImportParameters:output_type -> plugin.keystore.operations.v1.GetImportParametersResponse
	18, // 42: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ImportKeyMaterial:output_type -> plugin.keystore.operations.v1.ImportKeyMaterialResponse
	20, // 43: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKey:output_type -> plugin.keystore.operations.v1.ValidateKeyResponse
	22, // 44: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ValidateKeyAccessData:output_type -> plugin.keystore.operations.v1.ValidateKeyAccessDataResponse
	24, // 45: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.TransformCryptoAccessData:output_type -> plugin.keystore.operations.v1.TransformCryptoAccessDataResponse
	26, // 46: plugin.keystore.operations.v1.KeystoreInstanceKeyOperation.ExtractKeyRegion:output_type -> plugin.keystore.operations.v1.ExtractKeyRegionResponse
