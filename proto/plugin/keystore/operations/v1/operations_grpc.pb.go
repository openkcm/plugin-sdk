...
type KeystoreInstanceKeyOperationClient interface {
	...
	// CreateKeyForImport generates an empty key in pending import state
...
func (c *keystoreInstanceKeyOperationClient) DeleteKey(ctx context.Context, in *DeleteKeyRequest, opts ...grpc.CallOption) (*DeleteKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_DeleteKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) EnableKey(ctx context.Context, in *EnableKeyRequest, opts ...grpc.CallOption) (*EnableKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_EnableKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) DisableKey(ctx context.Context, in *DisableKeyRequest, opts ...grpc.CallOption) (*DisableKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_DisableKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) GetImportParameters(ctx context.Context, in *GetImportParametersRequest, opts ...grpc.CallOption) (*GetImportParametersResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_GetImportParameters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) ImportKeyMaterial(ctx context.Context, in *ImportKeyMaterialRequest, opts ...grpc.CallOption) (*ImportKeyMaterialResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_ImportKeyMaterial_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) ValidateKey(ctx context.Context, in *ValidateKeyRequest, opts ...grpc.CallOption) (*ValidateKeyResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_ValidateKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) ValidateKeyAccessData(ctx context.Context, in *ValidateKeyAccessDataRequest, opts ...grpc.CallOption) (*ValidateKeyAccessDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_ValidateKeyAccessData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) TransformCryptoAccessData(ctx context.Context, in *TransformCryptoAccessDataRequest, opts ...grpc.CallOption) (*TransformCryptoAccessDataResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_TransformCryptoAccessData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *keystoreInstanceKeyOperationClient) ExtractKeyRegion(ctx context.Context, in *ExtractKeyRegionRequest, opts ...grpc.CallOption) (*ExtractKeyRegionResponse, error) {
	...
	err := c.cc.Invoke(ctx, KeystoreInstanceKeyOperation_ExtractKeyRegion_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedKeystoreInstanceKeyOperationServer must be embedded to have
...
func (UnimplementedKeystoreInstanceKeyOperationServer) testEmbeddedByValue() {}
...
func RegisterKeystoreInstanceKeyOperationServer(s grpc.ServiceRegistrar, srv KeystoreInstanceKeyOperationServer) {
	// If the following call panics, it indicates UnimplementedKeystoreInstanceKeyOperationServer was
