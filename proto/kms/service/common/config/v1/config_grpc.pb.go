...
const (
	Config_Configure_FullMethodName = "/kms.service.common.config.v1.Config/Configure"
	Config_Validate_FullMethodName  = "/kms.service.common.config.v1.Config/Validate"
)
...
func (c *configClient) Configure(ctx context.Context, in *ConfigureRequest, opts ...grpc.CallOption) (*ConfigureResponse, error) {
	...
	err := c.cc.Invoke(ctx, Config_Configure_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *configClient) Validate(ctx context.Context, in *ValidateRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	...
	err := c.cc.Invoke(ctx, Config_Validate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var Config_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kms.service.common.config.v1.Config",
	...
	Metadata: "kms/service/common/config/v1/config.proto",
}
